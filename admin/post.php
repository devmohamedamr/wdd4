...
if(isset($_POST['save'])){
    ...
    if($upload){
        ...
        $q = "insert into `post` (`title`,`artical`,`img`,`created_at`) values ('$title','$post','$imgname','$timestamp')";
...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="design/index2.html" class="logo">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="post.php"><i class="fa fa-circle-o text-red"></i> <span>Post</span></a></li>
                <li><a href="view.php"><i class="fa fa-circle-o text-yellow"></i> <span>View All</span></a></li>
                <li><a href="user.php"><i class="fa fa-circle-o text-aqua"></i> <span>Users</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
                    ...
                    <form role="form" action="post.php" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="ed" name="artical"></textarea>
                            </div>
                            <div class="form-group">
